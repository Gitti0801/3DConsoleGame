...
namespace ThreeDimensionalConsoleGame.GameObjects
{
    class Angel : Enemy
    {
        ...
        public Angel(Game game, int x, int y, int z, int health, GameWorld world) : base(game, x, y, z, health, world)
        {
            Game = game;
            X = x;
            Z = z;
            ...
            Note = $"An enemy. It seems to emit a celestial aura. You are not sure if you might kill it.";
            LootTable = Game.LootService.CreateLootTable("AngelsFeather:0.1");
        }
